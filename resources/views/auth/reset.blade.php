                    ...
                    <div class="col-12 col-md-7 col-lg-5 col-xl-4 py-md-11">
                        <div class="card border-0 shadow-sm">
                            <div class="card-body">
                                ...
                                <p class="text-center mb-6">Please enter your email address below to receive
                                    instructions
                                    for resetting password.</p>

                                <form class="mb-4 mt-5" action="/reset" method="POST">
                                    @csrf
                                    ...
                                    <div class="text-center mt-5">
                                        <button class="btn btn-lg btn-primary" title="">Send Password</button>
                                    </div>
                                </form>
